...
function startround(){
     background("white");
     imagetodraw=Math.floor(Math.random()*quick_draw_data_set.length);
     sketch=document.getElementById("sketchtodraw").innerHTML=quick_draw_data_set[imagetodraw];
     timer=0;
...
function checksketch(){
      ...
      if(timercomplete=="complete"||answer=="set"){
        timercomplete="";
        answer="";
        updatecanvas();
      }
